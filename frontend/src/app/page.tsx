      ...
      <section className="py-20 bg-gray-50 dark:bg-dark-bg-primary">
        <div className="container-centered max-w-3xl">
          ...
          <div className="space-y-4">
            {[
              { q: "Is Cosmo Folio really free?", a: "Yes! You can instantly create a beautiful 6-page portfolio and export 2 high-quality PDFs completely for free. We are preparing a Pro version with unlimited pages and premium master templates — stay tuned!" },
