...
function generateEndPages100(): LayoutSpec[] {
  ...
  return [
    ...
    // ── MINIMALIST CONTACT: Focus on white space ──────────────────────────────────
    mk('end-min01','Minimalist · Center Dot',[rv('title',5,4,6,1),rv('meta',5,4,7,2)]),
    mk('end-min02','Minimalist · Top Left',[rv('title',1,4,1,2),rv('meta',1,4,3,3)]),
    mk('end-min03','Minimalist · Bottom Right',[rv('title',9,4,10,1),rv('meta',9,4,11,2)]),
    mk('end-min04','Minimalist · Sparse Split',[rv('title',2,4,6,1),rv('meta',8,4,6,2)]),
    mk('end-min05','Minimalist · Fine Line',[rv('title',1,12,6,1),rv('meta',1,12,7,1)]),
    mk('end-min06','Minimalist · Vertical Stream',[rv('title',6,2,2,3),rv('meta',6,2,5,6)]),
    mk('end-min07','Minimalist · Corners',[rv('title',1,3,1,2),rv('meta',10,3,11,2)]),
    mk('end-min08','Minimalist · Large Margin',[rv('title',4,6,4,2),rv('meta',4,6,6,4)]),
    mk('end-min09','Minimalist · Floating Info',[rv('title',3,3,3,2),rv('meta',8,3,8,3)]),
    mk('end-min10','Minimalist · Extreme Left',[rv('title',1,2,5,3),rv('meta',1,2,8,4)]),
    // ── EDITORIAL CONTACT: Magazine style ────────────────────────────────────────
    mk('end-ed01','Editorial · Full Bleed Title',[img(0,1,12,1,12),rv('title',1,12,1,4),rv('meta',1,4,10,3)]),
    mk('end-ed02','Editorial · Portrait Cover',[img(0,1,6,1,12),rv('title',8,4,3,3),rv('meta',8,4,6,4),rv('text',8,4,10,2)]),
    mk('end-ed03','Editorial · Typography Heavy',[rv('title',1,12,2,4),rv('subtitle',1,8,6,2),rv('meta',10,3,8,4)]),
    mk('end-ed04','Editorial · Thin Column',[img(0,2,4,2,10),rv('title',7,4,4,2),rv('meta',7,4,6,4),rv('legend',7,4,10,2)]),
    mk('end-ed05','Editorial · Fashion Spread',[img(0,1,5,1,12),img(1,6,3,1,12),rv('title',10,3,4,3),rv('meta',10,3,7,4)]),
    mk('end-ed06','Editorial · Dramatic Crop',[img(0,1,12,1,6),rv('title',2,8,8,2),rv('meta',2,4,10,3),rv('text',7,4,10,3)]),
    mk('end-ed07','Editorial · Block Quote',[rv('title',3,8,3,4),rv('meta',3,4,8,3),img(0,8,3,8,3)]),
    mk('end-ed08','Editorial · Table of Contents Style',[rv('title',1,4,2,2),rv('meta',6,6,2,10)]),
    mk('end-ed09','Editorial · Layered Images',[img(0,1,6,1,8),img(1,4,6,4,8),rv('title',11,2,4,4),rv('meta',1,4,10,3)]),
    mk('end-ed10','Editorial · Off-Grid Text',[img(0,1,8,1,12),rv('title',7,5,4,3),rv('meta',7,5,7,4)]),
    // ── ASYMMETRIC CONTACT: Off-grid and modern ──────────────────────────────────
    mk('end-as01','Asymmetric · Dynamic Left',[img(0,1,5,2,7),rv('title',3,6,9,2),rv('meta',7,4,3,4)]),
    mk('end-as02','Asymmetric · Zig Zag',[img(0,2,4,2,4),rv('title',7,4,4,2),img(1,4,4,7,4),rv('meta',9,3,9,3)]),
    mk('end-as03','Asymmetric · Floating Blocks',[img(0,1,4,1,5),rv('meta',6,4,3,4),img(1,8,5,8,5),rv('title',2,5,9,3)]),
    mk('end-as04','Asymmetric · Broken Grid',[img(0,1,7,1,6),rv('title',4,6,7,2),rv('meta',8,4,9,4)]),
    mk('end-as05','Asymmetric · Unbalanced Corners',[rv('title',1,8,1,3),img(0,10,3,2,5),rv('meta',1,5,10,3)]),
    mk('end-as06','Asymmetric · Scattered',[img(0,3,3,2,4),rv('title',8,4,3,2),img(1,1,4,8,4),rv('meta',6,3,9,3)]),
    mk('end-as07','Asymmetric · Offset Columns',[img(0,2,4,2,8),rv('title',7,4,4,2),rv('meta',7,4,7,4)]),
    mk('end-as08','Asymmetric · Chaotic',[rv('title',4,5,4,2),img(0,1,4,6,4),rv('meta',9,3,2,5),img(1,6,5,8,4)]),
    mk('end-as09','Asymmetric · Heavy Right',[rv('meta',2,3,4,4),img(0,6,7,1,12),rv('title',4,6,8,2)]),
    mk('end-as10','Asymmetric · Tension',[img(0,1,5,1,12),rv('title',10,3,10,2),rv('meta',10,3,1,4)]),
    // ── SPLIT-SCREEN CONTACT: Perfect divisions ──────────────────────────────────
    mk('end-sp01','Split · Perfect Half Horizontal',[img(0,1,12,1,6),rv('title',3,8,8,2),rv('meta',3,8,10,2)]),
    mk('end-sp02','Split · Perfect Half Vertical',[img(0,1,6,1,12),rv('title',8,4,4,2),rv('meta',8,4,6,4)]),
    mk('end-sp03','Split · One Third Vertical',[img(0,1,4,1,12),rv('title',6,6,4,2),rv('meta',6,6,6,4)]),
    mk('end-sp04','Split · Two Thirds Vertical',[img(0,1,8,1,12),rv('title',10,3,4,2),rv('meta',10,3,6,4)]),
    mk('end-sp05','Split · Diagonal Illusion',[img(0,1,6,1,6),img(1,7,6,7,6),rv('title',7,6,3,2),rv('meta',1,6,9,2)]),
    mk('end-sp06','Split · Thin Top Banner',[img(0,1,12,1,3),rv('title',2,10,5,2),rv('meta',2,10,7,4)]),
    mk('end-sp07','Split · Thin Bottom Banner',[rv('title',2,10,3,2),rv('meta',2,10,5,4),img(0,1,12,10,3)]),
    mk('end-sp08','Split · Central Divide',[rv('title',1,5,4,4),img(0,6,2,1,12),rv('meta',9,4,4,4)]),
    mk('end-sp09','Split · Reverse Half',[rv('title',2,4,4,2),rv('meta',2,4,6,4),img(0,7,6,1,12)]),
    mk('end-sp10','Split · Golden Ratio',[img(0,1,7,1,12),rv('title',9,3,4,2),rv('meta',9,3,6,4)]),
    // ── BRUTALIST CONTACT: Bold and high contrast ────────────────────────────────
    mk('end-br01','Brutalist · Giant Title',[rv('title',1,12,1,6),rv('meta',1,6,8,4),rv('text',7,6,8,4)]),
    mk('end-br02','Brutalist · Grid Lock',[rv('title',1,6,1,6),rv('meta',7,6,1,6),img(0,1,6,7,6),img(1,7,6,7,6)]),
    mk('end-br03','Brutalist · Mega Meta',[rv('meta',1,12,1,8),rv('title',1,12,10,2)]),
    mk('end-br04','Brutalist · Heavy Corners',[rv('title',1,4,1,3),rv('meta',9,4,10,3),img(0,5,4,5,4)]),
    mk('end-br05','Brutalist · Stripe Blocks',[img(0,1,12,2,2),img(1,1,12,6,2),img(2,1,12,10,2),rv('title',1,12,4,2),rv('meta',1,12,8,2)]),
    mk('end-br06','Brutalist · Text Wall',[rv('title',1,12,1,4),rv('text',1,12,5,4),rv('meta',1,12,9,4)]),
    mk('end-br07','Brutalist · Left Heavy',[rv('title',1,8,1,5),rv('meta',1,8,6,7),img(0,10,3,1,12)]),
    mk('end-br08','Brutalist · Frame',[img(0,1,12,1,1),img(1,1,12,12,1),img(2,1,1,2,10),img(3,12,1,2,10),rv('title',3,8,4,3),rv('meta',3,8,7,3)]),
    mk('end-br09','Brutalist · Compressed',[rv('title',1,12,5,1),rv('meta',1,12,6,1),rv('text',1,12,7,1)]),
    mk('end-br10','Brutalist · Full Cover Image',[img(0,1,12,1,12),rv('title',1,12,1,6),rv('meta',1,12,7,6)]),
    // ── GRID/MOSAIC CONTACT: Multiple images ──────────────────────────────────────
    mk('end-gr01','Grid · 2x2 Matrix',[img(0,1,6,1,4),img(1,7,6,1,4),img(2,1,6,5,4),img(3,7,6,5,4),rv('title',1,12,10,1),rv('meta',1,12,11,2)]),
    mk('end-gr02','Grid · Tri-Image Left',[img(0,1,4,1,4),img(1,1,4,5,4),img(2,1,4,9,4),rv('title',6,6,4,2),rv('meta',6,6,7,4)]),
    mk('end-gr03','Grid · Tri-Image Top',[img(0,1,4,1,5),img(1,5,4,1,5),img(2,9,4,1,5),rv('title',3,8,7,2),rv('meta',3,8,9,3)]),
    mk('end-gr04','Grid · Chessboard',[img(0,1,6,1,6),rv('title',7,6,1,6),rv('meta',1,6,7,6),img(1,7,6,7,6)]),
    mk('end-gr05','Grid · 3x3 Small Images',[img(0,1,3,1,3),img(1,4,3,1,3),img(2,7,3,1,3),img(3,1,3,4,3),img(4,4,3,4,3),img(5,7,3,4,3),rv('title',11,2,1,3),rv('meta',11,2,4,4)]),
    mk('end-gr06','Grid · Surrounding Meta',[img(0,4,6,4,6),rv('title',1,12,1,2),rv('meta',1,12,11,2),rv('text',1,2,4,6)]),
    mk('end-gr07','Grid · Staggered Image Row',[img(0,1,3,2,6),img(1,5,3,4,6),img(2,9,3,6,6),rv('title',1,5,10,2),rv('meta',7,6,2,2)]),
    mk('end-gr08','Grid · Window Pane',[img(0,2,4,2,4),img(1,7,4,2,4),img(2,2,4,7,4),img(3,7,4,7,4),rv('title',1,12,1,1),rv('meta',1,12,12,1)]),
    mk('end-gr09','Grid · T-Shape',[img(0,1,12,1,4),img(1,5,4,5,5),rv('title',1,4,6,2),rv('meta',9,4,6,3)]),
    mk('end-gr10','Grid · Ladder',[img(0,2,3,2,3),img(1,5,3,5,3),img(2,8,3,8,3),rv('title',6,6,2,2),rv('meta',1,5,10,2)]),
    // ── ARCHITECTURAL CONTACT: Structured and clean ──────────────────────────────
    mk('end-ar01','Architectural · Data Sheet',[rv('title',1,4,1,2),rv('subtitle',1,4,3,1),rv('meta',1,4,4,8),img(0,5,8,1,12)]),
    mk('end-ar02','Architectural · Blueprint',[img(0,1,12,1,8),rv('title',1,4,9,3),rv('meta',5,4,9,3),rv('text',9,4,9,3)]),
    mk('end-ar03','Architectural · Scale Model',[img(0,3,8,3,6),rv('title',3,8,9,1),rv('meta',3,8,10,2)]),
    mk('end-ar04','Architectural · Section',[img(0,1,6,1,12),img(1,7,6,1,8),rv('title',7,6,9,1),rv('meta',7,6,10,3)]),
    mk('end-ar05','Architectural · Elevation',[img(0,1,12,1,4),img(1,1,12,5,4),rv('title',1,6,10,2),rv('meta',7,6,10,2)]),
    mk('end-ar06','Architectural · Master Plan',[img(0,1,12,1,9),rv('title',1,3,11,2),rv('meta',5,8,11,2)]),
    mk('end-ar07','Architectural · Concept Sketch',[img(0,4,6,2,5),rv('title',4,6,8,2),rv('meta',4,6,10,2)]),
    mk('end-ar08','Architectural · Tech Specs',[rv('title',1,12,1,2),rv('meta',1,6,4,8),rv('legend',7,6,4,8)]),
    mk('end-ar09','Architectural · Cross Section',[img(0,1,6,4,5),rv('title',8,5,4,2),rv('meta',8,5,6,3)]),
    mk('end-ar10','Architectural · Floor Plan',[img(0,2,8,2,8),rv('title',11,2,2,3),rv('meta',11,2,5,5)]),
  ]
}
