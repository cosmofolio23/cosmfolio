        ...
        <div className="grid md:grid-cols-5 gap-8 mb-8 pb-8 border-b border-slate text-left">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              ...
              <li><Link href="/tutorial" className="text-gray-300 hover:text-white transition">Tutorial</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              <li><Link href="/tutorial" className="text-gray-300 hover:text-white transition">Video Tutorial</Link></li>
              <li><Link href="/faq" className="text-gray-300 hover:text-white transition">Need help?</Link></li>
